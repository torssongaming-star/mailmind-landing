...
export function CommandPalette() {
  ...
  const staticItems: StaticItem[] = useMemo(() => [
    ...
    { kind: "nav",    id: "nav-stats",      label: "Statistik",           icon: BarChart2,       href: "/app/insights/stats",          keywords: ["stats", "metrics", "siffror", "analytics"] },
    { kind: "nav",    id: "nav-activity",   label: "Aktivitetslogg",      icon: Activity,        href: "/app/insights/activity",       keywords: ["audit", "logg", "events", "history"] },
