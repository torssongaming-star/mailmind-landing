      ...
      <div className="h-16 border-b border-white/5 px-8 flex items-center justify-between bg-[#050B1C]/50 backdrop-blur-xl sticky top-0 z-20">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-white font-bold tracking-tight">
            {article?.id ? "Edit Article" : "New Knowledge Article"}
          </h2>
          {formData.status && (
            <span className={cn(
              "px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest border ml-2",
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 text-slate-400 hover:text-white transition-all text-xs font-bold uppercase tracking-widest"
          >
          ...
          <button
            ...
            disabled={isPending}
            className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-xl text-xs font-bold uppercase tracking-widest transition-all border border-white/10 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isPending}
            className="flex items-center gap-2 px-4 py-2 bg-primary text-black hover:bg-cyan-300 rounded-xl text-xs font-bold uppercase tracking-widest transition-all shadow-lg shadow-primary/10 disabled:opacity-50"
          >
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-4">
              <input
                ...
                className="w-full bg-transparent border-none text-white text-4xl font-bold placeholder:text-slate-800 focus:ring-0 p-0 outline-none"
              />
              <div className="flex items-center gap-2 text-slate-500 text-sm font-mono bg-white/[0.02] p-2 rounded-lg border border-white/5">
                <span>mailmind.se/admin/knowledge/</span>
                <input 
                  type="text"
                  value={formData.slug}
            ...
            <div className="space-y-2">
              ...
              <div className="bg-[#050B1C] border border-white/5 rounded-2xl overflow-hidden shadow-2xl focus-within:border-primary/30 transition-all">
                {preview ? (
                  <div className="p-8 prose prose-invert prose-sm max-w-none min-h-[500px]">
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent border-none p-8 text-slate-300 text-base font-serif leading-relaxed focus:ring-0 outline-none min-h-[500px] resize-none"
                  />
                )}
              </div>
            </div>
